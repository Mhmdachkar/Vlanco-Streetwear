...
const Navigation = () => {
  ...
  const navLinks = [
    ...
    { name: 'Scroll Demo', href: '/scroll-demo' },
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16 sm:h-18">
            ...
            <div className="flex items-center gap-2.5 sm:gap-3">
              ...
              >
                ...
                {/* Hover Glow */}
                <motion.div
                  className="absolute inset-0 bg-cyan-400/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"
                />
              </motion.button>
              ...
              <HoverCard openDelay={150} closeDelay={100}>
                <HoverCardTrigger asChild>
                  ...
                  >
                    ...
                    {/* Heartbeat Effect */}
                    <motion.div
                      className="absolute inset-0 bg-red-400/20 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"
                      animate={{
                        scale: [1, 1.2, 1],
                        opacity: [0, 0.5, 0]
                      }}
              ...
              <div className="relative user-menu-container">
                ...
                <AnimatePresence>
                  {showUserMenu && user && (
                    <motion.div 
                      className="absolute right-0 top-full mt-2 w-48 bg-card/95 backdrop-blur-md border border-cyan-400/20 rounded-lg shadow-lg shadow-cyan-400/10 py-2 z-50"
          ...
          <AnimatePresence>
            {isMobileMenuOpen && (
              <motion.div 
                className="md:hidden border-t border-cyan-400/20 bg-background/95 backdrop-blur-md relative z-40"
