      ...
      >
        ...
        <div className="relative h-80 overflow-hidden">
          <motion.img
            ...
            animate={hoveredProduct === product.id ? { scale: 1.04 } : { scale: 1 } as any}
...
const ProductGrid = () => {
  ...
  const enhancedProducts = useMemo(() => filteredProducts.map((product, index) => {
    ...
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            {/* Simplified moving gradient background */}
            <motion.div
