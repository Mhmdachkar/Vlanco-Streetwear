...
const MaskCollection = () => {
  ...
  // Filter for masks
  const maskProducts = products.filter(p => p.category === 'Masks');
  const filteredProducts = maskProducts.filter(product =>
  ...
  return (
    <div className="font-inter">
      ...
      <section className="relative min-h-[40vh] bg-gradient-to-br from-background via-purple-900/10 to-background overflow-hidden flex items-center justify-center">
        <h1 className="text-4xl md:text-5xl font-black tracking-tight text-center py-16">Mask Collection</h1>
      </section>
